    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="brand">
                <a href="" style="font-size:30px;font-weight:bold;">
                    <!-- <img src="{{ asset('/img/logo-dark.png') }}" alt="Klorofil Logo" class="img-responsive logo"> -->
                    E-Voting
                </a>
            </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img
                                    src="{{ asset('/img/user.png') }}" class="img-circle" alt="Avatar">
        ...
        <div id="sidebar-nav" class="sidebar">
            <div class="sidebar-scroll">
                <nav>
                    <ul class="nav">
                        <li><a href="{{ route('home') }}" class="<?php if($judul == 'Dashboard') :?>active<?php endif;?>"><i
                                    class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
                        <li><a href="{{ route('admin.kandidat') }}"
                                class="<?php if($judul == 'Kandidat') :?>active<?php endif;?>"><i class="lnr lnr-user"></i>
                                <span>Kandidat</span></a></li>
                        <li><a href="{{ route('admin.voters') }}"
                                class="<?php if($judul == 'Voters') :?>active<?php endif;?>"><i class="lnr lnr-users"></i>
                                <span>Voters</span></a></li>
                        <li><a href="{{ route('logout') }}"
                                onclick="event.preventDefault(); document.getElementById('logout-form').submit();"> <i
                                    class="lnr lnr-exit"></i>{{ __('Logout') }}</a></li>
        ...
        <footer>
            <div class="container-fluid">
                <p class="copyright">&copy; 2022 E-Voting.</p>
